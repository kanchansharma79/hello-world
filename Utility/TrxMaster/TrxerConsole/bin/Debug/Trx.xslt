        ...
        <div id="divToRefresh" class="wrapOverall">
              ...
              <xsl:for-each select="$classSet">
                ...
                <tr>
                  <th scope="row" class="column1">
                    <xsl:value-of select="trxreport:GetShortDateTime(/t:TestRun/t:Times/@creation)"/>
                  </th>                  
          ...
          <Table>
            ...
            <tbody>
              <xsl:for-each select="/t:TestRun/t:Results/t:UnitTestResult">
                ...
                <xsl:if test="position() &gt;= 1 and position() &lt;=5">
                  ...
                  <tr>
                    ...
                    <td>
                      <xsl:value-of select="/t:TestRun/t:TestEntries/t:TestEntry[@testId=$testId]/t:TcmInformation/@testCaseId" />
                    </td>
              ...
              <tr>
                <td colspan="5">
                  <h6>TRX Html Viewer log - Horizon Hobby</h6>
                </td>
              </tr>
            </tbody>
          </Table>
